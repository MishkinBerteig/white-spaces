...
window.locales.en.translation = 
{
	...
	"support": "White-Spaces Support",
	"offline": "Offline. Click for more.",
	"error": "Sorry, but something went wrong. Please contact support@white_spaces.com",
	"welcome": "Welcome",
	...
	"name": "Name",
	"confirm_subject": "White-Spaces Email Confirmation",
	"confirm_body": "Thank you for signing up at White-Spaces.\nPlease click on the following link to confirm your email address.\n",
	"confirm_action": "Confirm Now",
	"team_invite_membership_subject": "Team Invitation for %s",
	"team_invite_membership_body": "You have been invited to %s on White-Spaces. Please click on the following link to accept the invitation.",
	"team_invite_user_body": "You have been invited to %s on White-Spaces.\nYour temporary password is \"%s\".\nPlease click on the following link to accept the invitation.",
	...
	"team_new_member_body": "%s just joined Team %s on White-Spaces.",
	"space_invite_membership_subject": "%s invited you to a Space %s ",
	"space_invite_membership_body": "You have been invited by %s to join a Space %s on White-Spaces. Please click on the following link to accept the invitation.",
	"space_invite_membership_action": "Accept",
	"folder_invite_membership_subject": "Space",
	"folder_invite_membership_body": "You have been invited to a Team on White-Spaces. Please click on the following link to accept the invitation.",
	...
	"white_spaces_pro_ad_folders": "With White-Spaces Pro, you can organize an unlimited amount of Spaces in Folders and manage access controls for each Folder. Would you like to learn more about Pro features?",
	"white_spaces_pro_ad_versions": "With White-Spaces Pro, you can save unlimited versions of each Space to track your progress or keep snapshots safe. Would you like to learn more about Pro features?",
	"white_spaces_pro_ad_pdf": "With White-Spaces Pro, you can export your Spaces as crisp PDFs for archiving, mailing around, or printing. Do you want to learn more about Pro features?",
	"white_spaces_pro_ad_zip": "With White-Spaces Pro, you can export the contents of a Space as a ZIP package. Do you want to learn more about Pro features?",
	"white_spaces_pro_ad_colors": "With White-Spaces Pro, you can mix your own colors using a professional color picker.",
	...
	"landing_claim": "White-Spaces lets you easily combine all kinds of media on virtual whiteboards: Text notes, photos, web links, even videos and audio recordings. ",
	"landing_example": "People use White-Spaces to organize their ideas, in teams to see whole projects at a glance, or in schools and universities for richer, connected learning experiences.",
	"spaces": "My Spaces",
	...
	"landing_features_text": "The new White-Spaces 5 has a streamlined, beautiful user interface that makes your work easier and more fun than ever before – while giving you even more powerful features:",
	...
	"welcome_subject": "Welcome to White-Spaces",
	"welcome_body": "Hello!\nThank you for signing up at White-Spaces.<br>We hope you will enjoy working in Spaces.<br>Remember, your account includes unlimited collaborators. Feel free to share your Spaces with friends and colleagues all over the world.",
	...
	"pro_ad_history_headline": "When you upgrade to White-Spaces Pro, you will see a history of recent updates across all your (shared) Spaces here.",
	"password_reset_subject": "Reset Password for White-Spaces",
	"password_reset_body": "You requested a reset of your White-Spaces password.\nPlease click on the following link to set a new password.",
	"password_reset_action": "Reset Now",
	"was_offline": "The connection to White-Spaces was interrupted. If you have unsaved work, please keep this browser tab open until the connection is re-established, then touch the unsaved objects again.",
	"subscription_failed_user_subject": "Problem with your White-Spaces Payment",
	...
	"subscription_failed_team_subject": "Problem with your White-Spaces Payment",
...
window.locales.de.translation = 
{
	...
	"error": "Entschuldigung, etwas ist schiefgegangen. Bitte kontaktiere support@white_spaces.com",
	"welcome": "Willkommen",
	...
	"title": "Titel",
	"name": "Name",
	"confirm_subject": "E-Mail Bestätigung für White-Spaces",
	"confirm_body": "Danke, dass du dich bei White-Spaces angemeldet hast.\nBitte klicke auf den folgenden Link, um deine E-Mail Adresse zu bestätigen.\n ",
	"confirm_action": "E-Mail Bestätigen",
	"team_invite_membership_subject": "Einladung zu %s auf White-Spaces",
	"team_invite_membership_body": "Du wurdest zu %s auf White-Spaces eingeladen. \n Bitte klicke auf den folgenden Link, um die Einladung anzunehmen.",
	"team_invite_user_body": "Du wurdest zu %s auf White-Spaces eingeladen. Dein temporäres Passwort ist \"%s\".\n Bitte klicke auf den folgenden Link, um die Einladung anzunehmen.",
	"team_invite_admin_body": " %s wurde zu %s auf White-Spaces eingeladen. Das temporäres Passwort ist \"%s\".",
	...
	"white_spaces_pro_ad_folders": "Mit White-Spaces Pro kannst du beliebig viele Spaces in Ordnerstrukturen organisieren und für jeden Ordner Zugriffsrechte regeln. Möchtest du mehr über die Pro-Version erfahren?",
	"white_spaces_pro_ad_versions": "Mit White-Spaces Pro kannst du beliebig viele Versionen deines Spaces festhalten und später die Entwicklungsgeschichte nachvollziehen. Möchtest du mehr über die Pro-Version erfahren?",
	"white_spaces_pro_ad_pdf": "Mit White-Spaces Pro kannst du Spaces und sogar ganze Ordner als druckreife PDFs exportieren oder per Mail versenden. Möchtest du mehr über die Pro-Version erfahren?",
	"white_spaces_pro_ad_zip": "Mit White-Spaces Pro kannst du die Inhalte deiner Spaces jederzeit als ZIP-Paket exportieren. Möchtest du mehr über die Pro-Version erfahren?",
	"white_spaces_pro_ad_colors": "White-Spaces Pro enthält einen Profi-Farbmischer, mit dem du deine eigenen Farben mischen kannst.",
	...
	"landing_claim": "Mit White-Spaces kannst du multimedial auf virtuellen Whiteboards im Internet zusammenarbeiten: Kombiniere Texte, Fotos, Websites oder sogar Videos und Sounds. ",
	"landing_example": "White-Spaces ist ideal, um Ideen zu visualisieren, in kreativen Teams Projekte zu überblicken oder um den Unterricht in Schulen und Universitäten interaktiv zu gestalten.",
	"spaces": "Meine Spaces",
	"access_editor_link": "Sofort-Mitmachen-Link",
	"access_editor_link_desc": "Mit diesem Link kann man sogar ohne White-Spaces-Account sofort mitarbeiten. Praktisch!",
	...
	"landing_features_text": "White-Spaces 5 hat eine brandneue Benutzeroberfläche, die das Arbeiten einfacher und intuitiver und macht - gleichzeitig aber auch mehr mächtige Werkzeuge bereitstellt.",
	...
	"welcome_subject": "Willkommen bei White-Spaces",
	"welcome_body": "Danke, dass du dich bei White-Spaces angemeldet hast. <br> Wir hoffen, du wirst viel Spaß mit White-Spaces haben. <br> Vergiss nicht, dass du mit unbegrenzt vielen Kollegen und Freunden kostenlos zusammen arbeiten kannst. ",
	...
	"password_reset_subject": "Neues Passwort für White-Spaces",
	"password_reset_body": "Du möchtest das Passwort für deinen White-Spaces Account zurücksetzen?\nBitte klicke dafür auf den folgenden Link:",
	"password_reset_action": "Jetzt Passwort neu setzen",
	"pro_ad_history_headline": "Nach einem Upgrade zu White-Spaces Pro kannst du hier einen Überblick über alle aktuellen Aktivitäten in Spaces bekommen.",
...
window.locales.fr.translation = 
{
	...
	"support": "Aide White-Spaces",
	"offline": "Désolé , mais les serveurs White-Spaces ne peuvent pas être atteint pour le moment. Plus d' informations ici.",
	"error": "Désolé, une erreur s'est produite. Veuillez contacter support@white_spaces.com",
	"welcome": "Bienvenue",
	...
	"ceo": "Gestionnaire",
	"name": "name",
	"confirm_subject": "Confirmation de l'email White-Spaces",
	"confirm_body": "Merci pour votre inscription à White-Spaces.\nSil vous plaît cliquez sur le lien suivant pour confirmer votre adresse e-mail.",
	"confirm_action": "Confirmer",
	"team_invite_membership_subject": "Team Invitation for %s",
	"team_invite_membership_body": "You have been invited to %s on White-Spaces.\nPlease click on the following link to accept the invitation.",
	"team_invite_user_body": "You have been invited to %s on White-Spaces.\nYour temporary password is \"%s\".\nPlease click on the following link to accept the invitation.",
	"team_invite_admin_body": "%s was invited for your team: %s. The temporary password is \"%s\".",
	"team_invite_membership_acction": "Accept",
	...
	"white_spaces_pro_ad_folders": "Avec White-Spaces Pro, vous pouvez organiser un nombre illimité de espaces dans les dossiers et gérer les contrôles d'accès pour chaque dossier. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"white_spaces_pro_ad_versions": "Avec White-Spaces Pro, vous pouvez enregistrer des versions illimitées de chaque espace pour suivre vos progrès ou de conserver des instantanés sécurité. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"white_spaces_pro_ad_pdf": "Avec White-Spaces Pro, vous pouvez exporter vos espaces et même des dossiers entiers belles PDF pour l'archivage, de diffusion, ou autour de l'impression. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"white_spaces_pro_ad_zip": "Avec White-Spaces Pro, vous pouvez exporter le contenu d'un espace comme un paquet ZIP. Voulez-vous en savoir plus sur les fonctionnalités Pro?",
	"white_spaces_pro_ad_colors": "Avec White-Spaces Pro, vous pouvez mélanger vos propres couleurs en utilisant un sélecteur de couleur professionnelle.",
	"profile_caption": "Profil",
	...
	"landing_example": "Que vous soyez étudiant, enseignant ou chercheur: Avec White-Spaces il est facile pour vous de créer, de gérer et de partager des cours ou le travail en classe. Développez vos théories visuellement. Organisez des notes de recherche, web, images, audio et vidéo.",
	"spaces": "Espaces",
	"access_editor_link": "Lien instantané.",
	"access_editor_link_desc": "Donnez ce lien à tous ceux que vous voulez inviter rapidement. Ils n’ont pas besoin créer un compte White-Spaces.",
	...
	"landing_features_text": "Le tout nouveau White-Spaces 5 vous permet de travailler bien plus facilement grâce à sa magnifique interface simplifiée.",
	...
	"password_reset_subject": "Réinitialiser le Mot de passe pour White-Spaces",
...
window.locales.oc.translation = 
{
    ...
    "support": "Assisténcia White-Spaces",
    "offline": "Fòra linha. Clicatz per mai d’opcions.",
    "error": "O planhèm, quicòm a trucat. Mercés de contactar support@white_spaces.com",
    ...
    "ceo": "Gestionari",
    "name": "Nom",
    "confirm_subject": "Corrièl de confirmacion de White-Spaces",
    "confirm_body": "Mercés de vòstra inscripcion a White-Spaces.\nMercés de clicar lo ligam seguent per confirmar vòstra adreça electronica.\n",
    "confirm_action": "Confirmar",
    "team_invite_membership_subject": "Invitacion d’equipa per %s",
    "team_invite_membership_body": "Qualqu’un vos a convidat a %s sus White-Spaces. Mercés de clicar sul ligam seguent per acceptar l’invitacion.",
    "team_invite_user_body": "Qualqu’un vos a convidat a %s sus White-Spaces.\nVòstre senhal temporari es « %s ».\nMercés de clicar sul ligam seguent per acceptar l’invitacion.",
    ...
    "team_new_member_body": "%s a rejonch l’equipa %s sus White-Spaces",
    ...
    "folder_invite_membership_body": "Qualqu’un vos a convidat a Team sus White-Spaces. Clicatz lo ligam seguent per acceptar l’invitacion.",
    ...
    "landing_claim": "White-Spaces vos permet de facilament combinar quin que siá tipe de mèdias sus un tablèu virtual : tèxte, nòtas, ligams web, amai vidèos e enregistraments àudio. ",
    "landing_example": "Lo monde utiliza White-Spaces per organizar  lors idèas, en equipa per veire totes los projèctes en una ulhada, a l’escòla e a l’universitat pels mai rics, experiéncia d’aprendissatge connectat.",
    "spaces": "Mos espacis",
    ...
    "password_reset_subject": "Reïnicializar lo senhal per White-Spaces",
    ...
    "was_offline": "La connexion a White-Spaces es estada copada. S’avètz de trabalh pas enregistratz, gardatz aqueste onglet de navigador dobèrt fins que la connexion siá restablida puèi tocatz de nòu los elements pas enregistrats.",
    "subscription_failed_user_subject": "Problèma amb lo pagament White-Spaces",
    "subscription_failed_user_body": "Unfortunately, we could not process your Payment-method. You can easly create a new payment method including PayPal in your account settings.",
	"subscription_failed_team_subject": "Problem with your White-Spaces Payment",
    "subscription_failed_team_body": "Unfortunately, we could not process your Payment-method for your Team-Account. Please fix your payment method asap.",
